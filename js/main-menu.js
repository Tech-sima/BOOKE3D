...
(function() {
    ...
    function initMainMenu() {
        ...
        // 3D карта - свайп функциональность отключена
        console.log('🎮 3D карта активна - свайп отключен');
    ...
    function initSwipeFunctionality(imageElement) {
        ...
        function animate() {
            ...
            if (Math.abs(nx - currentX) > 0.1 || Math.abs(ny - currentY) > 0.1) {
                ...
                currentY = ny;
                applyTransform();
                // обновим индикаторы при изменении положения
                try { updateProfitIndicators(); } catch (_) {}

...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (employeeLevelsInitialized) {
        console.log('⚠️ Employee levels already initialized, skipping...');
        return;
    }
    
    initEmployeeLevels();
    employeeLevelsInitialized = true;
    console.log('✅ Employee levels system initialized');
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (employeeLevelsDOMInitialized) {
        console.log('⚠️ Employee levels DOM already initialized, skipping...');
        return;
    }
    ...
    console.log('✅ Employee levels DOM initialized');
}); 
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (partnerTasksInitialized) {
        console.log('⚠️ Partner tasks already initialized, skipping...');
        return;
    }
    ...
    console.log('✅ Partner tasks panel initialized');
});
    ...
    try {
        ...
        if (myId) {
            ...
            try {
                ...
                console.warn('Partner tasks check non-JSON response', { status: r.status, text });
            }
        ...
        console.warn('Partner tasks check error', e);
    }

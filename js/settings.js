...
function updateAllTexts() {
    ...
    try {
        ...
        console.warn('⚠️ Error updating shop items:', error);
    }
    ...
    try {
        ...
        console.warn('⚠️ Error updating building panels:', error);
    }
    ...
    try {
        ...
        console.warn('⚠️ Error updating tasks:', error);
    }
}
...
function initSettings() {
    ...
    try {
        ...
        console.warn('⚠️ Error updating language UI:', error);
    }
    ...
    try {
        ...
        console.warn('⚠️ Error updating texts:', error);
    }
}
